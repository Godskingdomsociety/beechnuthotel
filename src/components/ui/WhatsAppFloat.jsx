export default function WhatsAppFloat() {
  const phone = '[HOTEL_WHATSAPP_NUMBER]'
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-40 flex items-center gap-2 bg-[#25D366] text-white rounded-full px-4 py-2.5 shadow-[0_6px_28px_rgba(37,211,102,0.4)] text-sm font-medium no-underline transition-all duration-300 hover:-translate-y-1 hover:scale-105 hover:shadow-[0_10px_36px_rgba(37,211,102,0.55)] animate-wa-pulse"
